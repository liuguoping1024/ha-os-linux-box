...
from libs.bl702l.flash_select_do import create_flashcfg_table
from libs.bl702l.bootheader_cfg_keys import bootheader_len as header_len
...
def img_create_update_bootheader(bootheader_data, hash, seg_cnt, flashcfg_table_addr,
    ...
    bootheader_data[172:172 + 4] = bflb_utils.int_to_4bytearray_l(flashcfg_table_addr)
    bootheader_data[172 + 4:172 + 8] = bflb_utils.int_to_4bytearray_l(flashcfg_table_len)
