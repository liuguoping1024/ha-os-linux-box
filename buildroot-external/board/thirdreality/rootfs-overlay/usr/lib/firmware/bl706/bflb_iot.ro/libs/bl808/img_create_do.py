...
def img_update_efuse_group1(cfg,
                            sign,
                            pk_hash,
                            flash_encryp_type,
                            flash_key,
...
def img_create_get_img_start_addr(bootheader_data):
    ...
    bootentry.append(
        bflb_utils.bytearray_to_int(bflb_utils.bytearray_reverse(bootheader_data[\
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_d0_index_number+16 : \
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_d0_index_number+16+4])))
    bootentry.append(
        bflb_utils.bytearray_to_int(bflb_utils.bytearray_reverse(bootheader_data[\
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_lp_index_number+16 : \
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_lp_index_number+16+4])))
    return bootentry
