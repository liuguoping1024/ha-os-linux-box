...
bootcfg_start_pos = 124  # 0x7C
bootcfg_len = 48
bootcpucfg_start_pos = bootcfg_start_pos + bootcfg_len  # 172 0xAC
bootcpucfg_len = 16
bootcpucfg_m0_index = 0
bootcpucfg_m1_index = 1

boot2_start_pos = bootcpucfg_start_pos + bootcpucfg_len * (bootcpucfg_m1_index + 1)  # 204 0xCC
boot2_len = 8

flashcfg_table_start_pos = boot2_start_pos + boot2_len  # 212 0xD4
flashcfg_table_len = 8

patch_on_read_start_pos = flashcfg_table_start_pos + flashcfg_table_len  # 220 0xDC
patch_on_read_len = 16

patch_on_jump_start_pos = patch_on_read_start_pos + patch_on_read_len  # 236 0xEC
patch_on_jump_len = 16

crc32_start_pos = patch_on_jump_start_pos + patch_on_jump_len  # 252 0xFC
...
bootheader_cfg_keys = {
    ...
    # boot cpu m1 config
    "m1_config_enable": {
        "offset": str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0),
        "pos": "0",
        "bitlen": "8"
    },
    "m1_halt_cpu": {
    ...
    "m1_image_address_offset": {
        "offset": str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 4),
        "pos": "0",
        "bitlen": "32"
    },
    "m1_boot_entry": {
        "offset": str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 8),
        "pos": "0",
        "bitlen": "32"
    },
    "m1_msp_val": {
        "offset": str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 12),
        "pos": "0",
        "bitlen": "32"
    },
    # boot2 config
