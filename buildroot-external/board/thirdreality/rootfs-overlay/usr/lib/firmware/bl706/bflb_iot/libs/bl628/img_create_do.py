...
def img_create_get_img_start_addr(bootheader_data):
    ...
    bootentry.append(
        bflb_utils.bytearray_to_int(bflb_utils.bytearray_reverse(bootheader_data[\
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_m0_index_number+8 : \
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_m0_index_number+8+4])))
    bootentry.append(
        bflb_utils.bytearray_to_int(bflb_utils.bytearray_reverse(bootheader_data[\
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_m1_index_number+8 : \
            bootcpucfg_start+bootcpucfg_length*bootcpucfg_m1_index_number+8+4])))
    return bootentry
